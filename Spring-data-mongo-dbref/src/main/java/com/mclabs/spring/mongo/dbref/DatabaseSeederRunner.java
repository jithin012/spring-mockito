...
import com.mclabs.spring.mongo.dbref.domain.Aircraft;
...
import com.mclabs.spring.mongo.dbref.domain.FlightType;
...
public class DatabaseSeederRunner implements CommandLineRunner {
	...
	public DatabaseSeederRunner(FlightInformationRepository flightRepository, AirportRepository airportRepository,
	...
	private void seed() {
		...
		Airport copenhagen = new Airport("7ed990d2-6471-485d-931e-c77729dc0f25", "Copenhagen Airport", "Copenhagen",
				30298531);
